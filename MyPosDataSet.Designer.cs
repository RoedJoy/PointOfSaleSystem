...
namespace MyPos.MyPosDataSetTableAdapters {
...
SELECT ID, UserID, FirstName, MiddleName, LastName, Age, Gender, Address, BirthDate, Username, Password, DateCreated, DateUpdated FROM Cashiers WHERE (ID = @ID)";
        ...
        public virtual int Fill(MyPosDataSet.CashiersDataTable dataTable) {
        ...
        public virtual MyPosDataSet.CashiersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyPosDataSet.CashiersDataTable dataTable = new MyPosDataSet.CashiersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyPosDataSet.CashiersDataTable dataTable) {
